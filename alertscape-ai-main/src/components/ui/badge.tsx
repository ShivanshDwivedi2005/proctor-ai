  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        danger: "border-transparent bg-danger/20 text-danger border border-danger/30",
        pending: "border-transparent bg-warning/20 text-warning border border-warning/30",
        active: "border-transparent bg-success/20 text-success border border-success/30",
